...
L["Ammo Pouch"] = "Сумка боеприпасов"
...
L["DataBars"] = "Панели данных"
L["DataTexts"] = "Текстовые панели"
...
L["Flyout Spacing"] = "Расстояние между элементами"
L["Focus"] = "Фокус"
...
L["Disable Name Only"] = "Отключить «Только имя»"
L["Show Target Indicator"] = "Показать индикатор цели"
...
L["Displays an icon on totem nameplates."] = "Показывает иконку на неймплейтах тотемов."
...
L["BLOCK"] = "Блок"
L["BOSS"] = "Босс"
L["BUFFOPTIONS_LABEL"] = "Баффы и дебаффы"
L["CLASS"] = "Клass"
L["CHANNEL"] = "Канал"
L["COLOR"] = "Цвет"
L["COLORS"] = "Цвета"
...
L["TRADE"] = "Обмен"
L["Use Keybind Color"] = "Использовать цвет клавиш"
L["Use a separate color for keybind text."] = "Использовать отдельный цвет для текста клавиш."
L["Keybind Text Color"] = "Цвет текста клавиш"
L["Use Stack Count Color"] = "Использовать цвет счётчика стаков"
L["Use a separate color for stack count text."] = "Использовать отдельный цвет для текста счётчика стаков."
L["Stack Count Color"] = "Цвет счётчика стаков"
L["Use Macro Color"] = "Использовать цвет макросов"
L["Use a separate color for macro text."] = "Использовать отдельный цвет для текста макросов."
L["Macro Color"] = "Цвет макросов"
...
L["UNIT_NAMEPLATES_TYPE_3"] = "Наложение + стекинг"
L["Nameplate Soft Stacking"] = "Мягкий стекинг неймплейтов"
L["Horizontal Detection"] = "Горизонтальная проверка"
L["Vertical Gap"] = "Вертикальный зазор"
L["Base Speed"] = "Базовая скорость"
L["Raise Speed"] = "Скорость подъема"
L["Lower Speed"] = "Скорость опускания"
L["Reset Speed"] = "Скорость возврата"
L["Maximum Raise"] = "Максимальный подъем"
L["Top Screen Clamp"] = "Верхний экранный clamp"
L["Origin Offset"] = "Смещение от базовой позиции"
L["Horizontal distance within which plates affect each other."] = "Горизонтальная дистанция, в пределах которой неймплейты влияют друг на друга."
L["Desired minimum vertical gap between overlapping enemy nameplates."] = "Желаемый минимальный вертикальный зазор между вражескими неймплейтами."
L["Global movement speed multiplier for soft stacking."] = "Глобальный множитель скорости движения для мягкого стекинга."
L["Maximum vertical raise in pixels to prevent too large gaps."] = "Максимальный подъем в пикселях, чтобы не было слишком больших разрывов."
L["Top screen inset while stacking is active."] = "Верхняя граница экрана во время работы стекинга."
L["Additional offset relative to the base plate position."] = "Дополнительное смещение относительно базовой позиции неймплейта."
L["WHISPER"] = "Шепот"
L["WORLD_MAP"] = "Карта"
...
--- new namepleates
L["Nameplate Engine"] = "Движок неймплейтов"
L["NAMEPLATE_ENGINE_HELP"] = "Большинство переключателей здесь необязательны. Обязательно: |cff1784d1Включить|r неймплейты ElvUI (вверху этой страницы) и |cff1784d1/reload|r. Оставьте |cff1784d1прогноз здоровья|r включённым. |cff1784d1Только имена|r — первый пункт (0), чтобы были полноценные плейты. Блок «Личный» нужен только если включён |cff1784d1личный ресурс|r."
L["Restore Engine Defaults"] = "Сбросить движок к умолчанию"
L["NAMEPLATE_ENABLE_RELOAD"] = "|cffFF0000Неймплейты включены, но ещё не загружены.|r Введите |cff1784d1/reload|r для применения."
L["Client nameplate engine settings (CVar). Replaces the default Interface > Names panel."] = "Настройки клиентского движка неймплейтов (CVar). Заменяют стандартную панель «Интерфейс > Имена»."
L["Alpha of nameplates that are not your current target."] = "Прозрачность индикаторов, которые не являются вашей текущей целью."
L["Used when |cff1784d1Use Target Scale|r is disabled in General."] = "Используется, когда в разделе «Общие» отключено |cff1784d1масштабирование цели|r."
L["Scale & Alpha"] = "Масштаб и прозрачность"
L["NAMEPLATE_SHOW_ONLY_NAMES"] = "Только имена"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_0"] = "Никогда"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_1"] = "При получении урона"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_2"] = "Всегда"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_3"] = "На друзьях"
L["NAMEPLATE_TARGET_RADIAL_POSITION"] = "Позиция цели"
L["NAMEPLATE_TARGET_RADIAL_POSITION_OPTION_0"] = "Цель на экране"
L["NAMEPLATE_TARGET_RADIAL_POSITION_OPTION_1"] = "Цель вне экрана"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET"] = "Личный индикатор при цели"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_0"] = "Никогда"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_1"] = "Всегда"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_2"] = "При выборе цели"
L["Load Distance"] = "Дистанция загрузки"
L["Maximum distance (yards) at which nameplates are loaded."] = "Максимальное расстояние (в ярдах), на котором загружаются индикаторы здоровья."
...
L["Scale up the targeted nameplate."] = "Масштабировать индикатор здаровья цели."
L["Width of your own (personal) nameplate."] = "Ширина вашего собственного индикатора здоровья."
L["Height of your own (personal) nameplate."] = "Высота вашего собственного индикатора здоровья."
...
L["Targeting Player"] = "Целится в игрока"
...
L["Targeting Pet"] = "Целится в питомца"
L["If enabled then the filter will only activate when the unit is targeting your pet."] = "Если включено, фильтр будет активирован только тогда, когда ваш питомец является целью юнита."
L["Not Targeting Pet"] = "Не целится в питомца"
L["If enabled then the filter will only activate when the unit is not targeting your pet."] = "Если включено, фильтр будет активирован только тогда, когда ваш питомец не является целью юнита."
...
L["Show incoming heal and absorb bars on the nameplate health."] = "Показывать входящие лечения и поглощение (абсорб) на индикаторе здоровья"
L["Absorb Texture"] = "Текстура поглощения"
L["Height of the prediction bars. Set to -1 to match the health bar."] = "Высота полос прогнозирования. Установите значение -1, чтобы совпадала с полосой здоровья."
L["Max amount of overflow past the end of the health bar (used for OVERFLOW absorb style)."] = "Максимальная величина превышения за пределами полосы здоровья (используется для стиля поглощения с переполнением)."
...
L["Display the unit name who interrupted a spell on the castbar."] = "Отображает имя прервавшего текущее заклинание на полосе."
L["Stack Auras"] = "Стакать ауры"
L["This will join auras together which are normally separated."] = "Сливает вместе ауры, которые обычно разделены."
...
L["Display the class icon for players instead of the unit portrait."] = "Отображать иконку класса вместо портрета персонажа."
...
L["Enable the login message."] = "Включить сообщение при входе."
