...
L["Icon Frame"] = true
L["Displays an icon on totem nameplates."] = true
...
L["Nameplate Engine"] = true
L["NAMEPLATE_ENGINE_HELP"] = "Most toggles here are optional. Required: ElvUI NamePlates Enable (top of this page) + reload. Keep |cff1784d1Predicted Health|r ON. |cff1784d1Show Only Names|r = first option (0) for full plates. Personal nameplate options only matter if |cff1784d1Show Personal Resource|r is enabled."
L["Restore Engine Defaults"] = true
L["NAMEPLATE_ENABLE_RELOAD"] = "|cffFF0000Nameplates are enabled but not loaded yet.|r Type |cff1784d1/reload|r to apply."
L["Client nameplate engine settings (CVar). Replaces the default Interface > Names panel."] = true
L["Used when |cff1784d1Use Target Scale|r is disabled in General."] = true
L["Scale & Alpha"] = true
L["NAMEPLATE_SHOW_ONLY_NAMES"] = "Show Only Names"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_0"] = "Never"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_1"] = "On Damaged Creatures"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_2"] = "Always"
L["NAMEPLATE_SHOW_ONLY_NAMES_OPTION_3"] = "On Friends"
L["NAMEPLATE_TARGET_RADIAL_POSITION"] = "Target Position"
L["NAMEPLATE_TARGET_RADIAL_POSITION_OPTION_0"] = "On Screen"
L["NAMEPLATE_TARGET_RADIAL_POSITION_OPTION_1"] = "Off Screen"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET"] = "Show Personal Nameplate With Target"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_0"] = "Never"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_1"] = "Always"
L["DISPLAY_PERSONAL_SHOW_WITH_TARGET_OPTION_2"] = "When Targeting"
...
L["TRADE"] = "Trade"
L["Use Keybind Color"] = true
L["Use a separate color for keybind text."] = true
L["Keybind Text Color"] = true
L["Use Stack Count Color"] = true
L["Use a separate color for stack count text."] = true
L["Stack Count Color"] = true
L["Use Macro Color"] = true
L["Use a separate color for macro text."] = true
L["Macro Color"] = true
L["Auto Toggle"] = true
L["Bank"] = true
L["Vendor"] = true
...
L["UNIT_NAMEPLATES_TYPE_3"] = "Overlapping + Stacking"
L["Nameplate Soft Stacking"] = "Nameplate Soft Stacking"
L["Horizontal Detection"] = "Horizontal Detection"
L["Vertical Gap"] = "Vertical Gap"
L["Base Speed"] = "Base Speed"
L["Raise Speed"] = "Raise Speed"
L["Lower Speed"] = "Lower Speed"
L["Reset Speed"] = "Reset Speed"
L["Maximum Raise"] = "Maximum Raise"
L["Top Screen Clamp"] = "Top Screen Clamp"
L["Origin Offset"] = "Origin Offset"
L["Horizontal distance within which plates affect each other."] = "Horizontal distance within which plates affect each other."
L["Desired minimum vertical gap between overlapping enemy nameplates."] = "Desired minimum vertical gap between overlapping enemy nameplates."
L["Global movement speed multiplier for soft stacking."] = "Global movement speed multiplier for soft stacking."
L["Maximum vertical raise in pixels to prevent too large gaps."] = "Maximum vertical raise in pixels to prevent too large gaps."
L["Top screen inset while stacking is active."] = "Top screen inset while stacking is active."
L["Additional offset relative to the base plate position."] = "Additional offset relative to the base plate position."
L["WHISPER"] = "Whisper"
L["WORLD_MAP"] = "Map"
